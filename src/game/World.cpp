...
void World::LoadConfigSettings(bool reload)
{
    ...
    setConfigPos(CONFIG_FLOAT_RATE_DROP_ITEM_REFORGED,   "Rate.Drop.Item.Reforged",   1.0f);
    ...
    setConfigPos(CONFIG_FLOAT_RATE_DROP_ITEM_RELIC,      "Rate.Drop.Item.Relic",      1.0f);
