...
class PlayerBotAI: public PlayerAI
{
    public:
        ...
        // Helpers
        bool SpawnNewPlayer(WorldSession* sess, uint8 classId, uint32 raceId, uint32 mapId, uint32 instanceId, float dx, float dy, float dz, float o, Player* pClone = nullptr, std::string const& spawnName = std::string());
